...
macro(pd_add_test name sources)
    ...
    target_compile_definitions(test_${name} PUBLIC TEST_RESOURCE="${CMAKE_CURRENT_LIST_DIR}/test/resource")
    target_compile_definitions(test_${name} PUBLIC TEST_VISUALIZE=${TEST_VISUALIZE})
    
    target_link_libraries( test_${name} PRIVATE pd::vslam GTest::gtest_main )
    add_test( NAME ${name}.UnitTest COMMAND test_${name})
    set_property(TARGET test_${name} PROPERTY POSITION_INDEPENDENT_CODE ON)
