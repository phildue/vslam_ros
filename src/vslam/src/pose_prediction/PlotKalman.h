...
public:
  ...
  private:
    ...
    void createCorrectionPlot(const std::vector<double> &t, const std::vector<double> &c, const std::string &name) const;
    void createVelocityPlot(const std::vector<double> &t, const std::vector<double> &x, const std::string &name) const;
    void createUpdatePlot(const std::vector<double> &t, const std::vector<double> &u, const std::string &name) const;
    void plotStateCov(const std::vector<double> &t, const std::vector<double> &cx, const std::string &name) const;
    void plotExpectationCov(const std::vector<double> &t, const std::vector<double> &ce, const std::string &name) const;
    void plotKalmanGain(const std::vector<double> &t, const std::vector<double> &k, const std::string &name) const;
    void plotMeasurementCov(const std::vector<double> &t, const std::vector<double> &ce, const std::string &name) const;
  };
