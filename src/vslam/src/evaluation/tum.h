 ...
 */
void writeTrajectory(const Trajectory &traj, const std::string &path, bool writeCovariance = false);
...
public:
  ...
  DataLoader(const std::string &datasetRoot = "/mnt/dataset/tum_rgbd/", const std::string &sequenceId = "rgbd_dataset_freiburg2_desk");
