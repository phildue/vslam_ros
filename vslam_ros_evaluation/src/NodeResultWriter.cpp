...
,_sub(this->create_subscription<nav_msgs::msg::Odometry>("/odom",10,std::bind(&NodeResultWriter::callback,this,std::placeholders::_1)))
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(NodeResultWriter)