...
,_sub(create_subscription<nav_msgs::msg::Odometry>("/odom",10,std::bind(&NodeGtLoader::callback,this,std::placeholders::_1)))
...
RCLCPP_COMPONENTS_REGISTER_NODE(NodeGtLoader)
